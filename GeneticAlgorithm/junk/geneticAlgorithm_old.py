...
CROSSOVER_RATE = 0.120          # Probability of crossover
MUTATION_RATE = 0.287          # Probability of a bit-flip mutation
TOURNAMENT_SIZE = 5           # Size of the pool for selection
MAX_NO_IMPROVEMENT = 10       # Stop if no better solution found after 20 generations
# --- END GA PARAMETERS ---
